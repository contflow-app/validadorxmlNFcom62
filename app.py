...
def validate_cfop_pf_pj_nao_contrib(
    ...
    >>> Ajuste: se o CFOP estiver em branco, NÃO vamos mais considerar erro.
    ...
    for det in det_nodes:
        ...
        # NOVO: se CFOP estiver vazio, não vamos mais considerar erro aqui
        if not cfop:
            continue
...
def validate_custom_rules(
    ...
    # CFOP para PF/PJ não contribuinte (ignorando SVA e ignorando CFOP vazio)
